...
export declare type SelectivePartial<Type, OptionalKeys extends keyof Type> = Omit<Type, OptionalKeys> & Partial<Type>;
...
export declare type RemoveCollideConfigA<T extends CO> = SelectivePartial<CollideAConfig<T>, "callback">;
/** Variant of CollideABConfig to be used when removing listeners (where callback is optional). */
export declare type RemoveCollideConfigAB<T extends CO, K extends CO> = SelectivePartial<CollideABConfig<T, K>, "callback">;
export declare type InternalCollideRemoveConfig = SelectivePartial<InternalCollideConfig, "callback">;
export interface ListenerInfo<T extends CO, K extends CO> {
    target?: CO;
    callback: CollideCallback<T, K>;
    context?: CollideContext;
}
export declare type ListenerMap = Map<CO, ListenerInfo<any, any>[]>;
